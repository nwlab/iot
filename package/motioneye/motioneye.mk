...
define MOTIONEYE_INSTALL_TARGET_CMDS
    ...
    cp $(TOPDIR)/$(MOTIONEYE_PKGDIR)/platformupdate.py $(DST_DIR)
    cp $(TOPDIR)/$(MOTIONEYE_PKGDIR)/ipctl.py $(DST_DIR)
    cp $(TOPDIR)/$(MOTIONEYE_PKGDIR)/servicectl.py $(DST_DIR)
    cp $(TOPDIR)/$(MOTIONEYE_PKGDIR)/watchctl.py $(DST_DIR)
    cp $(TOPDIR)/$(MOTIONEYE_PKGDIR)/extractl.py $(DST_DIR)
